    ...
    <View style={styles.container}>
      {!keyboardStatus && (
        ...
        <View style={styles.options}>
          <TouchableOpacity style={{...styles.optionsbox, borderBottomColor: selected === screens.login ? '#FA4A0C' : '#00000'}} onPress={() => setSelected(screens.login)}>
            <Text style={{color: '#FFFFFF', fontSize: 16}}>Entrar</Text>
          </TouchableOpacity>
          <TouchableOpacity style={{...styles.optionsbox, borderBottomColor: selected === screens.signup ? '#FA4A0C' : '#00000'}} onPress={() => setSelected(screens.signup)}>
